...
Private Function BuildDisplayValue(ByVal ws As Worksheet, ByVal rowIndex As Long) As String
    ...
    BuildDisplayValue = JoinDisplayValues(Array(GetImportedCellText(ws, rowIndex, "table_number"), GetImportedFullNameText(ws, rowIndex), GetImportedCellText(ws, rowIndex, "personal_number"), GetImportedCellText(ws, rowIndex, "military_unit")))
...
Private Sub CopySelectionToDataSheet(ByVal sourceRow As Long)
    ...
    With targetSheet
        ...
        .Cells(targetRow, 5).Value = GetImportedCellText(sourceSheet, sourceRow, "table_number")



        .Cells(targetRow, 6).Value = GetImportedCellText(sourceSheet, sourceRow, "personal_number")
...
Private Function RowMatchesSearch(ByVal ws As Worksheet, ByVal rowIndex As Long, ByVal searchValue As String) As Boolean
    ...
    If InStr(1, GetImportedCellText(ws, rowIndex, "table_number"), searchValue, vbTextCompare) > 0 Then RowMatchesSearch = True: Exit Function
